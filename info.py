...
CLONE_MODE = is_enabled(environ.get('P_TTI_SHOW_OFF', "True"), True)
...
LOGS_CHANNEL = int(environ.get('LOGS_CHANNEL', 0))
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://graph.org/file/dfdb90233a632602e81be.png")
