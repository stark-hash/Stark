...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, CPICS, BATCH_FILE_CAPTION, AUTO_DELETE_TIME, AUTO_DELETE, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, CLONE_START_MESSAGE, FORCE_SUB_TEXT, SUPPORT_CHAT, CDB_NAME 
...
async def handle_callback_query(client, query: CallbackQuery):
    if query.data == "help":
        ...
        buttons = [
            [
                InlineKeyboardButton('​🇸​​🇹​​🇦​​🇷​​🇰​ ​🇧​​🇴​​🇹​ ​🇺​​🇵​​🇩​​🇦​​🇹​​🇪​​🇸​', url='https://t.me/StarkBotUpdates')
            ],
            [
